...
namespace App\Http\Services\Fortnite\Player\Stats\Update\Gamepad;
...
class UpdateGamepadStatsService
{
    static public function updateGamepadStatsToDB(string $playerId, array $response, string $currentTime): void
    {

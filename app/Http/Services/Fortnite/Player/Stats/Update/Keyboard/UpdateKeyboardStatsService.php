...
namespace App\Http\Services\Fortnite\Player\Stats\Update\Keyboard;
...
class UpdateKeyboardStatsService
{
    static public function updateKeyboardStatsToDB(string $playerId, array $response, string $currentTime): void
    {

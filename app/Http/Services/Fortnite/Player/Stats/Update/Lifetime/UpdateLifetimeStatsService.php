...
namespace App\Http\Services\Fortnite\Player\Stats\Update\Lifetime;
...
class UpdateLifetimeStatsService
{
    static public function updateLifetimeStatsToDB(string $playerId, array $response, string $currentTime): void
    {
        Cache::purge('playerStats:' . $playerId);

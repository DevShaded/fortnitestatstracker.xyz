...
class CreateFortnitePlayerDuoGamepadsTable extends Migration
{
    public function up(): void
    {
        Schema::create('fortnite_player_duo_gamepads', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('fortnite_player_duo_gamepads');
    }
}

...
class CreateFortnitePlayerOverallKeyboardsTable extends Migration
{
    public function up()
    {
        Schema::create('fortnite_player_overall_keyboards', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('fortnite_player_overall_keyboards');
    }
}

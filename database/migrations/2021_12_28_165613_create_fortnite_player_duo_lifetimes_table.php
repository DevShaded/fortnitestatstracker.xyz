...
class CreateFortnitePlayerDuoLifetimesTable extends Migration
{
    public function up()
    {
        Schema::create('fortnite_player_duo_lifetimes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('fortnite_player_duo_lifetimes');
    }
}

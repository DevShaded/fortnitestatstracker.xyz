...
class CreateFortnitePlayerLTMLifetimesTable extends Migration
{
    public function up(): void
    {
        Schema::create('fortnite_player_ltm_lifetimes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('fortnite_player_ltm_lifetimes');
    }
}

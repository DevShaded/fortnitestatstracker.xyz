...
class CreateFortnitePlayerDuoKeyboardsTable extends Migration
{
    public function up()
    {
        Schema::create('fortnite_player_duo_keyboards', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('fortnite_player_duo_keyboards');
    }
}

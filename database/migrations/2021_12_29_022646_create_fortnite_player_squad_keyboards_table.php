...
class CreateFortnitePlayerSquadKeyboardsTable extends Migration
{
    public function up(): void
    {
        Schema::create('fortnite_player_squad_keyboards', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('fortnite_player_squad_keyboards');
    }
}
